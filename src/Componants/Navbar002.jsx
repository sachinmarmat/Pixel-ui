  ...
  return (
    <div>
      <div className=" min-h-[35rem] sm:min-h-[44rem] relative">
        ...
        {/* Content */}
        <div className="relative z-10 container mx-auto max-w-screen-xl px-4 pt-44 sm:pt-42 sm:pl-27 items-center sm:items-start text-center sm:text-left lg:pt-65">
          {/* Heading */}
