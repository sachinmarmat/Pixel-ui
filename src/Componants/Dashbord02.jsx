...
const Dashbord02 = () => {
    ...
    return (
        <div className='flex justify-around mt-10 items-start'>
            <div className=''>
                ...
                <div className='flex flex-col gap-6 items-center '>
                    {alljobs.map((job, i) => (
                        <div
                            key={i}
                            className="flex flex-col md:flex-row justify-between border shadow-sm hover:shadow-lg transition  bg-gray-100/80  rounded-xl w-120 border-gray-400 p-6 gap-6 "
                        >
                            {/* Left Side */}
                            <div className='flex flex-col gap-4'>
                                <div className="flex gap-6">  {/* <img src={img} alt="logo" className="w-12" /> */}
                                    <BsFillFileEarmarkCodeFill className='text-5xl bg-orange-600 p-1 rounded' />
                                    <div className="flex items-center gap-4 font-semibold text-lg md:text-xl mb-3">
                                        <h1>{job.title}</h1>
                                    </div></div>
                                <p className="text-[16px] font-semibold text-gray-700">{job.location}</p>
                            </div>
            ...
            <div className=''>
                <h1 className='text-3xl font-bold  pl-4 pb-8 '>Recent Application</h1>
