        ...
        <>
            ...
            >
                <div className=" container m-auto relative z-10 ">
                    <div className=" flex pt-18 flex-col gap-7 px-5">
                        {/* Logo + Brand */}
                        <div className="flex items-center gap-3">
                            <a href="/">
                                <img src={img} alt="logo-img" className="w-16 rounded-4xl" />
                            </a>
                            <h1 className="text-3xl font-medium text-white">Pixelgenix</h1>
                        </div>

                        {/* Login Box */}
                        <div className="bg-gray-100/20  sm:p-7 rounded-3xl">
                            <div className="flex flex-col lg:flex-row justify-center  items-center text-center">
                                ...
                                <div className="flex flex-col items-center gap-10 lg:w-1/2">
                                    <h1 className="text-3xl pt-2 sm:text-5xl  font-bold text-white">
                                ...
                                <div className="flex flex-col gap-4  p-6 sm:p-8 rounded-2xl w-full lg:w-1/3 shadow-md">
