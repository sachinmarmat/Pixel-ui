...
const Login = () => {
  ...
  const handleReverify = async () => {
    try {
      setLoading(true);
      const res = await axios.post("https://job-portal-backend-2q8i.onrender.com//api/auth/resend-verification", {
  ...
  const logindata = async (e) => {
    ...
    try {
      setLoading(true);
      const res = await axios.post(`https://job-portal-backend-2q8i.onrender.com//api/auth/user/login`, loginform);
  ...
  const handleForgotPassword = async (e) => {
    ...
    try {
      setLoading(true);
      const res = await axios.put(`https://job-portal-backend-2q8i.onrender.com//api/user/profile`, {
        email: loginform.email,
        newPassword,
      });
