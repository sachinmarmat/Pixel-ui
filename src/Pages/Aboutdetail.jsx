...
const Aboutdetail = () => {
    return (
            <div className='container m-auto flex flex-wrap justify-around w-[100%]'>
                <div className=' mt-10'>
                    <div className='flex flex-col gap-7 max-w-150 mt-5'>
                    ...
                    <div className='flex flex-col gap-10 mt-15 '>
                        ...
                        <div className='flex flex-wrap gap-10 text-xl font-medium'>
                ...
                <div className=' items-center flex flex-col '>
                    ...
                    <div className='flex gap-3'>
                        <div className='border border-gray-500 p-1 flex flex-col gap-2 flex-wrap text-center max-w-50 rounded items-center'>
                        ...
                        <div className='border border-gray-500 p-1 flex flex-col gap-3 flex-wrap text-center max-w-50  rounded items-center'>
                            <FaEye className='text-blue-500 text-2xl rounded-full bg-blue-100 shadow-[0_0_10px_2px_rgba(59,130,246,0.5)] p-1 cursor-pointer' />
                            <h2 className='text-xl font-bold'>Mission</h2>
                            <p >Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cum, vitae non!
