...
const Aboutdetail = () => {
  return (
    <div className="container mx-auto flex flex-col lg:flex-row flex-wrap justify-between gap-10 px-4 lg:px-12 py-10">
      ...
      <div className="flex-1 flex flex-col gap-10">
        ...
        <div className="flex flex-col md:gap-10 gap-4">
          ...
          <div className="flex flex-wrap gap-8  text-xl  md:text-2xl md:m- font-medium">
      ...
      <div className="flex-1 flex flex-col items-center gap-6">
        ...
        <div className="flex flex-col sm:flex-row gap-6 w-full justify-center">
          <div className="border border-gray-300 p-5 flex flex-col gap-3 text-center rounded-lg flex-1 shadow-sm bg-white">
