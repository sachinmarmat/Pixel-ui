...
const Admindashboard = () => {
  ...
  const fetchMessages = async () => {
    try {
      const res = await axios.get("https://job-portal-backend-2q8i.onrender.com//api/inform/getmassage", {
  ...
  const handleDeleteMessage = async (id) => {
    try {
      const res = await axios.delete(`https://job-portal-backend-2q8i.onrender.com//api/inform/${id}/deletemassage`, {
        headers: { Authorization: `Bearer ${token}` },
      });
