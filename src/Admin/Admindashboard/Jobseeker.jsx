...
const Jobseeker = () => {
    ...
    const userdata = async () => {
        try {
            const res = await axios.get(
                `https://job-portal-backend-2q8i.onrender.com//api/admin/getjobseeker`,
                {
    ...
    const togalstatus = async (id, currentStatus) => {
        try {
            ...
            if (currentStatus === "active") {
                // Suspend user
                res = await axios.put(
                    `https://job-portal-backend-2q8i.onrender.com//api/admin/user/${id}/suspenduser`,
                    {},
                    {
                        headers: { Authorization: `Bearer ${token}` },
                    }
                ...
                // Reactivate user
                res = await axios.put(
                    `https://job-portal-backend-2q8i.onrender.com//api/admin/user/${id}/reactivateuser`,
                    {},
                    {
                        headers: { Authorization: `Bearer ${token}` },
                    }
    ...
    const deletejobseeker = async (id) => {
        ...
        try {
            await axios.delete(`https://job-portal-backend-2q8i.onrender.com//api/admin/user/${id}`, {
                headers: {
