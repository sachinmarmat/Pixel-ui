...
const Employers = () => {
    ...
    const employedata = async () => {
        try {
            const res = await axios.get(`https://job-portal-backend-2q8i.onrender.com/api/admin/getemploye`, {
    ...
    const togalstatus = async (id, currentStatus) => {
        try {
            ...
            if (currentStatus === "active") {
                // Suspend user
                res = await axios.put(
                    `https://job-portal-backend-2q8i.onrender.com/api/admin/employer/${id}/suspendemployer`,
                    {},
                    {
                        headers: { Authorization: `Bearer ${token}` },
                    }
                ...
                // Reactivate user
                res = await axios.put(
                    `https://job-portal-backend-2q8i.onrender.com/api/admin/employer/${id}/reactivateEmployer`,
                    {},
                    {
                        headers: { Authorization: `Bearer ${token}` },
                    }
    ...
    const deleteEmploye = async (id) => {
        ...
        try {
            await axios.delete(`https://job-portal-backend-2q8i.onrender.com/api/admin/employer/${id}`, {
                headers: {
