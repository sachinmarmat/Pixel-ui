...
const Employernav = () => {
    ...
    const linkstyle = ({ isActive }) =>
     ...
     ${isActive ? 'text-orange-700  bg-orange-100/30' : ' text-white hover:bg-blue-400'}`;
          ...
          transition-transform duration-300 items-center
           sm:w-78 "
            >
                ...
                <div className='border-b-2 sm:mb-9 border-orange-300/40'>
                </div>


                <nav className="flex flex-col gap-5  p-3 rounded-2xl sm:px-8">
                    <NavLink to="/Employedashboard" className={linkstyle}>
                        <TfiMenuAlt className="text-lg" />Post Jobs
                    </NavLink>
