          ...
          <div className='mt-8 px-1'>
            ...
            <div className='px-3 pt-5 flex flex-col gap-5'>
              <div className='flex justify-between text-xm font-medium  py-2 items-center'>
                <h1 className='flex flex-col '>Raghav Sharma<span className='text-gray-500 text-xs hover:underline'>Frontend Developer</span></h1>
                <button className='bg-green-400 p-o.5 px-1 rounded-2xl w-20'>
                  <h1 className=''>Active</h1></button>
                <h1 className=''>24 sep 2025</h1>
                <h2 className='text-xl'>22</h2>
                <div className='flex'>
              ...
              <div className='flex justify-between text-xm font-medium  py-2 items-center'>
                <h1 className='flex flex-col '>Raghav Sharma<span className='text-gray-500 text-xs hover:underline'>Frontend Developer</span></h1>
                <button className='bg-red-400 p-o.5 px-1 rounded-2xl w-20'>
                  <h1 className=''>Draft</h1></button>
                <h1 className=''>24 sep 2025</h1>
                <h2 className='text-xl'>11</h2>
                <div className='flex'>
                  <button className='border bg-blue-500 p-1 rounded hover:bg-blue-600 cursor-pointer'>Edit</button>
                  <button className='border bg-blue-500 p-1 rounded hover:bg-blue-600 cursor-pointer'>Close</button>
                </div>
              ...
              <div className='flex justify-between text-xm font-medium  py-2 items-center'>
                <h1 className='flex flex-col '>Raghav Sharma<span className='text-gray-500 text-xs hover:underline'>Frontend Developer</span></h1>
                <button className='bg-blue-300 p-o.5 px-1 rounded-2xl w-20'>
                  <h1 className=''>Active</h1></button>
                <h1 className=''>24 sep 2025</h1>
                <h2 className='text-xl'>21</h2>
                <div className='flex'>
                  <button className='border bg-blue-500 p-1 rounded hover:bg-blue-600 cursor-pointer'>Edit</button>
                  <button className='border bg-blue-500 p-1 rounded hover:bg-blue-600 cursor-pointer'>Close</button>
                </div>
